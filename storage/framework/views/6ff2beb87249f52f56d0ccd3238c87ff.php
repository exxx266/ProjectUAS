                ...
                <form action="<?php echo e(route('booking.store')); ?>" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <input type="date" name="tanggal" class="form-control" value="<?php echo e(old('tanggal')); ?>" required min="<?php echo e(date('Y-m-d')); ?>">
                        </div>
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <select name="slot_waktu" class="form-select" required>
                                ...
                                <option value="10:00" <?php echo e(old('slot_waktu') == '10:00' ? 'selected' : ''); ?>>10:00 WIB</option>
                                <option value="11:00" <?php echo e(old('slot_waktu') == '11:00' ? 'selected' : ''); ?>>11:00 WIB</option>
                                <option value="13:00" <?php echo e(old('slot_waktu') == '13:00' ? 'selected' : ''); ?>>13:00 WIB</option>
                                <option value="14:00" <?php echo e(old('slot_waktu') == '14:00' ? 'selected' : ''); ?>>14:00 WIB</option>
                                <option value="15:00" <?php echo e(old('slot_waktu') == '15:00' ? 'selected' : ''); ?>>15:00 WIB</option>
                                <option value="16:00" <?php echo e(old('slot_waktu') == '16:00' ? 'selected' : ''); ?>>16:00 WIB</option>
                                <option value="19:00" <?php echo e(old('slot_waktu') == '19:00' ? 'selected' : ''); ?>>19:00 WIB</option>
                                <option value="20:00" <?php echo e(old('slot_waktu') == '20:00' ? 'selected' : ''); ?>>20:00 WIB</option>
                            </select>
                        </div>
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <select name="kapster_id" class="form-select" required>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $kapsters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kapster): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <option value="<?php echo e($kapster->id); ?>" <?php echo e(old('kapster_id') == $kapster->id ? 'selected' : ''); ?>>
                                        <?php echo e($kapster->nama); ?> - <?php echo e($kapster->keahlian); ?>
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <select name="metode_pembayaran" class="form-select" required>
                                ...
                                <option value="QRIS" <?php echo e(old('metode_pembayaran') == 'QRIS' ? 'selected' : ''); ?>>QRIS (OVO, Gopay, Dana)</option>
                                <option value="Cash" <?php echo e(old('metode_pembayaran') == 'Cash' ? 'selected' : ''); ?>>Bayar Tunai di Kasir</option>
                            ...
                            <div class="col-md-6">
                                <div class="service-item d-flex justify-content-between align-items-center">
                                    <div class="form-check m-0">
                                        <input class="form-check-input" type="checkbox" name="layanan[]" value="<?php echo e($layanan->id); ?>" id="layanan_<?php echo e($layanan->id); ?>" <?php echo e((is_array(old('layanan')) && in_array($layanan->id, old('layanan'))) ? 'checked' : ''); ?>>
                                        <label class="form-check-label text-white ms-2" for="layanan_<?php echo e($layanan->id); ?>">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\h\Documents\Semester2\Pemrograman Web\ProjectUAS\resources\views/booking/create.blade.php ENDPATH**/ ?>